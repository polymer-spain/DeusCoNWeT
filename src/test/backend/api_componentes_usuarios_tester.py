...
def main():
	...
	if option in ["dashboard", "dashboard_borrado", "dashboard_predeterminados"]:
		...
		if option == "dashboard":
			...
			# TEST 5
			print "TEST 5: Obtener la lista de componentes del usuario 2, proporcionando una cookie de sesion"
			...
			# PRETEST 4
			print "PRETEST 4: Añadimos el componente al dashboard de usuario 2, si no está añadido ya"
			...
			# Casos de éxito
			# TEST 13
			print "TEST 13: Eliminar componente del usuario 2, con cookie de sesión correcta"
			print "Status esperado: 200"
			request_uri = components_basepath + component_rel_uri
			test_utils.make_request("DELETE", request_uri, params, 200, session2)

			# TEST 14
			print "TEST 14: Obtener info de usuario 2"
