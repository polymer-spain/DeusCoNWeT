angular.module('picbit').controller('UserHomeController', ['$scope', '$timeout','$rootScope', function ($scope, $timeout, $rootScope) {
	...
	$scope.catalogList = [
		{name:'twitter-timeline',
		 ...
		 hasToken: $rootScope.user && $rootScope.user.tokens['twitter'],
		 attributes: {
		...
		{name:'github-events',
		 ...
		 hasToken:$rootScope.user && $rootScope.user.tokens['github'],
		...
		},
		{
			...
			rate:1,
			hasToken:$rootScope.user && $rootScope.user.tokens['instagram'],
		...
		},
		{
			...
			rate:4,
			hasToken:$rootScope.user && $rootScope.user.tokens['googleplus'],
		...
		},
		{
			name: 'facebook-wall',
			rate: 3,
			hasToken:$rootScope.user && $rootScope.user.tokens['facebook'],
